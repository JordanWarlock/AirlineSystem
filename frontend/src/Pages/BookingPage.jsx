...
import { TextField, Button, Radio, RadioGroup, FormControlLabel, FormControl, FormLabel, Box, MenuItem, Select, InputLabel } from '@mui/material';
    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
        ...
        <h1>Book here</h1>
          <FormControl>
            ...
            <RadioGroup row value={flightType} onChange={(e) => setFlightType(e.target.value)} className="radio-group">
